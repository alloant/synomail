...
Revision ID: d6139b1d0d27
Revises: 
Create Date: 2024-01-08 17:58:09.881681
...
def upgrade():
    ...
    sa.Column('password_nas', sa.String(length=500), nullable=False),
    ...
    sa.Column('proc', sa.String(length=50), nullable=False),
